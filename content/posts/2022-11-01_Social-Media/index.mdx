...
From a brief anecdotal poll of my limited sample of social media followers (by no means representative sample) it was interesting to see the usage:
...
There are always methods we can take even at a personal level and even encourage / normalise in our communities.
